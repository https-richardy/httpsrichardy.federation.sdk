<h1 align="center">FEDERATION - SDK FOR .NET</h1>

### About This Project

This is the federation .NET SDK for my projects. Its goal is simple: make it easier for .NET applications to talk to the identity provider without reinventing the wheel.
...
For more details about the main Federation API, check out the official repository: [Federation API](https://github.com/https-richardy/httpsrichardy.federation.webapi)